...
#
# However, you usually do not need to see the original models
# definition from torchvision. Just use `print(models)` to see
# the modules and see bellow the `models.features` and
...
def squeezenet1_0(num_classes=1000, pretrained='imagenet'):
    r"""SqueezeNet models architecture from the `"SqueezeNet: AlexNet-level
    accuracy with 50x fewer parameters and <0.5MB models size"
...
def squeezenet1_1(num_classes=1000, pretrained='imagenet'):
    r"""SqueezeNet 1.1 models from the `official SqueezeNet repo
