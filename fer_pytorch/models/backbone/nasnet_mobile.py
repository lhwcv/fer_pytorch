...
def nasnetamobile(num_classes=1000, pretrained='imagenet'):
    r"""NASNetALarge models architecture from the
    ...
    if pretrained:
       ...
       #     new_last_linear = nn.Linear(models.last_linear.in_features, 1000)
       #     new_last_linear.weight.data = models.last_linear.weight.data[1:]
       #     new_last_linear.bias.data = models.last_linear.bias.data[1:]
       #     models.last_linear = new_last_linear
