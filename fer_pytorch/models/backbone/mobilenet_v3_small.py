...
class MobileNetV3(nn.Module):
    def __init__(self, n_class=1000, input_size=224, dropout=0.8, mode='small', width_mult=1.0):
        ...
        self.features = [conv_bn(3, input_channel, 2, nlin_layer=nn.ReLU)]
        self.classifier = []
        ...
        if mode == 'large':
            ...
            self.features.append(conv_1x1_bn(input_channel, last_conv, nlin_layer=nn.ReLU))
...
def mobilenetv3(pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        state_dict = torch.load('/home/lhw/m2_disk/work_dir/pretrained/mobilenetv3_small_67.4.pth.tar')
